-- =================================================================
-- ARCHIVO DE SCRIPT PARA CORREGIR LA GRILLA DE GESTIÓN DE MATRÍCULAS (FECHAS)
-- =================================================================

DELIMITER $$

--
-- 1. Actualización de `sp_get_matriculas_filtradas` para añadir campos de fecha faltantes
--
