...
-- Procedimiento para crear una matrícula (versión final)
DELIMITER $$
...
-- Procedimiento para obtener todos los profesores (versión final)
DELIMITER $$
...
-- Procedimiento para obtener grupos de matrícula (versión final)
DELIMITER $$
...
-- Procedimiento para obtener clases para el calendario
DELIMITER $$
