...
BEGIN
    -- Se corrige este procedimiento para asegurar que siempre devuelva el id_horario.
    -- La falta de este campo causaba un error de "Undefined index" en el controlador.
    SELECT
        m.id_matricula,
        a.id_alumno,
        ...
        h.id_horario, -- Campo corregido/asegurado
        h.hora_inicio,
        h.hora_fin,
        m.fecha_inicio,
        m.fecha_fin,
