...
-- Description: Updates the dates for an existing enrollment
--              and rebuilds the attendance records. This does
--              not change the id_horario.
-- =============================================
...
BEGIN
    ...
    -- 1. Get the current id_horario from the matricula. It will not be changed.
