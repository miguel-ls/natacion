-- =================================================================
-- ARCHIVO DE SCRIPT PARA CORREGIR LA VISUALIZACIÓN EN DETALLES DE MATRÍCULA
-- =================================================================

--
-- Este script actualiza el procedimiento almacenado para que la
-- concatenación de Area y Sub Area incluya la descripción de la sub area.
--

DELIMITER $$

-- Eliminar el procedimiento antiguo para poder recrearlo
DROP PROCEDURE IF EXISTS `sp_get_matricula_details_by_id`;

-- Recrear `sp_get_matricula_details_by_id` con la nueva concatenación
