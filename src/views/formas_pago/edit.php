...
<div class="form-container">
    ...
    <form action="index.php?url=formas_pago/update" method="POST">
        <input type="hidden" name="csrf_token" value="<?php echo $auth->getCsrfToken(); ?>">
        <input type="hidden" name="id_forma_pago" value="<?php echo htmlspecialchars($forma_pago['id_forma_pago']); ?>">

        <div class="form-group">
            <label for="nombre">Nombre</label>
            <input type="text" id="nombre" name="nombre" value="<?php echo htmlspecialchars($forma_pago['nombre']); ?>" required>
        </div>
        <div class="form-actions">
            <a href="index.php?url=formas_pago" class="btn btn-secondary">Cancelar</a>
            <button type="submit" class="btn btn-success">Actualizar Forma de Pago</button>
        </div>
    </form>
</div>
